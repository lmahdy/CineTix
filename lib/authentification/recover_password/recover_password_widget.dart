...
class _RecoverPasswordWidgetState extends State<RecoverPasswordWidget> {
  ...
  void initState() {
    ...
    _model.emailRecoverTextController ??= TextEditingController();
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(42.0, 70.0, 42.0, 50.0),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        Row(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: SizedBox(
                              width: 200.0,
                              child: TextFormField(
                                controller: _model.emailRecoverTextController,
                                ...
                                validator: _model
                                    .emailRecoverTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if (_model
                                  .emailRecoverTextController.text.isEmpty) {
                              ...
                              await authManager.resetPassword(
                                email: _model.emailRecoverTextController.text,
                                context: context,
                              );
                            },
                            text: 'Send',
                            options: FFButtonOptions(
                              ...
                              textStyle: FlutterFlowTheme.of(context)
                                  ...
                                  .override(
                                    fontFamily: 'Inter Tight',
                                    color: const Color(0xFF6B0606),
                                    letterSpacing: 0.0,
                                  ),
                              elevation: 0.0,
                              borderSide: const BorderSide(
                                color: Color(0xFF6B0606),
                              ),
                              borderRadius: BorderRadius.circular(8.0),
                            ),
                          ),
