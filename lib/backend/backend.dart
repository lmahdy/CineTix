...
import 'schema/evenement_record.dart';
import 'schema/film_record.dart';
import 'schema/planning_record.dart';
import 'schema/sallle_record.dart';
...
export 'schema/evenement_record.dart';
export 'schema/film_record.dart';
export 'schema/planning_record.dart';
export 'schema/sallle_record.dart';
...
/// Functions to query EvenementRecords (as a Stream and as a Future).
Future<int> queryEvenementRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EvenementRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EvenementRecord>> queryEvenementRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      EvenementRecord.collection,
      EvenementRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EvenementRecord>> queryEvenementRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query SallleRecords (as a Stream and as a Future).
Future<int> querySallleRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SallleRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SallleRecord>> querySallleRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SallleRecord.collection,
      SallleRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SallleRecord>> querySallleRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
