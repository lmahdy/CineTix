  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: StreamBuilder<SallleRecord>(
        stream: SallleRecord.getDocument(widget.hh!),
        builder: (context, snapshot) {
          ...
          final cardSallleRecord = snapshot.data!;
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            controller: _model.textController1 ??=
                              ...
                              text: cardSallleRecord.placecategories
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await widget.hh!.update({
                              ...mapToFirestore(
                                {
                                  'placecategories': FieldValue.arrayUnion([
                            ...
                            await widget.hh!.update({
                              ...mapToFirestore(
                                {
                                  'placecategories': FieldValue.arrayRemove([
                                    getSeatCategoriesDetailsFirestoreData(
                                      updateSeatCategoriesDetailsStruct(
                                        cardSallleRecord.placecategories
                                            .elementAtOrNull(widget.index!),
                                        clearUnsetFields: false,
                                      ),
                                      true,
