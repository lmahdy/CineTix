...
import '/planning/add_planning_event/add_planning_event_widget.dart';
import '/planning/check_salle/check_salle_widget.dart';
import 'package:flutter/material.dart';
import 'update_planning_event_model.dart';
export 'update_planning_event_model.dart';

class UpdatePlanningEventWidget extends StatefulWidget {
  const UpdatePlanningEventWidget({
    super.key,
    required this.t1,
  });
  ...
  @override
  State<UpdatePlanningEventWidget> createState() =>
      _UpdatePlanningEventWidgetState();
}

class _UpdatePlanningEventWidgetState extends State<UpdatePlanningEventWidget> {
  late UpdatePlanningEventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdatePlanningEventModel());
  }
