...
import 'upplupll_event_model.dart';
export 'upplupll_event_model.dart';

class UpplupllEventWidget extends StatefulWidget {
  const UpplupllEventWidget({
    super.key,
    required this.t2,
    required this.s2,
  });
  ...
  @override
  State<UpplupllEventWidget> createState() => _UpplupllEventWidgetState();
}

class _UpplupllEventWidgetState extends State<UpplupllEventWidget> {
  late UpplupllEventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpplupllEventModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PlanningRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final upplupllEventPlanningRecord = snapshot.data!;
                                                                                ...
                                                                                child: SizedBox(
                                                                                  ...
                                                                                  child: TextFormField(
                                                                                    controller: _model.textController1 ??= TextEditingController(
                                                                                      text: dateTimeFormat("d/M/y", upplupllEventPlanningRecord.date),
                                                                                    ),
                                                                                  ...
                                                                                  child: TextFormField(
                                                                                    controller: _model.textController2 ??= TextEditingController(
                                                                                      text: valueOrDefault<String>(
                                                                                        upplupllEventPlanningRecord.heure,
                                                                                        'HH/MM',
                                                                                      ),
                                                                                    ),
