  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PlanningRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final ticketsCopyPlanningRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: StreamBuilder<EvenementRecord>(
                stream: EvenementRecord.getDocument(
                    ticketsCopyPlanningRecord.events!),
                builder: (context, snapshot) {
                  // Customize what your widget looks like when it's loading.
                  if (!snapshot.hasData) {
                    return Center(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Card(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              final eventimageimages =
                                                  columnEvenementRecord.image
                                                      .toList();
                                              ...
                                              return GridView.builder(
                                                ...
                                                itemCount:
                                                    eventimageimages.length,
                                                itemBuilder: (context,
                                                    eventimageimagesIndex) {
                                                  final eventimageimagesItem =
                                                      eventimageimages[
                                                          eventimageimagesIndex];
                                                  return ClipRRect(
                                                    borderRadius:
